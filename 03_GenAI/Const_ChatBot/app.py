...
def search_construction_law(query: str) -> str:
    ...
    prompt = ChatPromptTemplate.from_messages([
        ("system", """당신은 건설기술진흥법 전문 법률 AI 서포터입니다.
아래 제공된 [법률 문서 내용]을 기반으로만 사용자의 질문에 정확하고 명확하게 답변하세요.
법 조항이 있다면 제X조 내용까지 언급하여 정확성을 높이세요.
...
# ---------------------------------------------------------
# 5. Tool 바인딩 및 실행 엔진 (Agent 역할 구현)
# ---------------------------------------------------------
