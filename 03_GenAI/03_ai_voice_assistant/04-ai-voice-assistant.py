# AI 음성 비서의 워크플로와 파이프라인 구축
# 사용자 음성데이터 --> STT --> openai model 응답 --> TTS --> 사용자 음성으로 듣기
...
def main():
    ...
    with col2:
        ...
        if "messages" not in st.session_state:
            st.session_state.messages=[{'role':'assistant','content':'저는 음성 비서입니다.'}]
